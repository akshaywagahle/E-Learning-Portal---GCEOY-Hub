  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      ...
      <form action="register.php" method="post">
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="contact" placeholder="Student Contact No.">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-user"></span>
            </div>
        ...
        <div class="input-group mb-3">
          ...
          <option value="6">Machanical Engineering</option>
        ...
        <div class="input-group mb-3">
          ...
          <option value="2">Sem I</option>
          <option value="3">Sem II</option>
          <option value="4">Sem III</option>
          <option value="5">Sem IV</option>
          <option value="6">Sem V</option>
          <option value="7">Sem VI</option>
          <option value="8">Sem VII</option>
          <option value="9">Sem VIII</option>
          </select>
...
if(isset($_POST['submit'])){
  ...
  $query = "INSERT into students(student_id,firstname,email,contact,password)VALUES('$sid','$sname','$email','$contact','$password')";
