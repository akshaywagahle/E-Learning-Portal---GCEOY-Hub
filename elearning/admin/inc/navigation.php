              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-2">
                   <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown <?php echo ($page === 'students') ? 'menu-open' : ''; ?>">
                      <a href="<?php echo base_url ?>admin/?page=students" class="nav-link <?php echo ($page === 'students') ? 'active' : ''; ?>">
                    ...
                    <li class="nav-item dropdown <?php echo ($page === 'faculty') ? 'menu-open' : ''; ?>">
                      <a href="<?php echo base_url ?>admin/?page=faculty" class="nav-link <?php echo ($page === 'faculty') ? 'active' : ''; ?>">
                    ...
                    <li class="nav-item dropdown <?php echo ($page === 'academic') ? 'menu-open' : ''; ?>">
                      <a href="<?php echo base_url ?>admin/?page=academic" class="nav-link <?php echo ($page === 'academic') ? 'active' : ''; ?>">
                    ...
                    <li class="nav-item dropdown <?php echo ($page === 'department') ? 'menu-open' : ''; ?>">
                      <a href="<?php echo base_url ?>admin/?page=department" class="nav-link <?php echo ($page === 'department') ? 'active' : ''; ?>">
                    ...
                    <li class="nav-item dropdown <?php echo ($page === 'lesson') ? 'menu-open' : ''; ?>">
                      <a href="<?php echo base_url ?>admin/?page=lesson" class="nav-link <?php echo ($page === 'lesson') ? 'active' : ''; ?>">
                    ...
                    <li class="nav-item dropdown <?php echo ($page === 'lesson/assignment') ? 'menu-open' : ''; ?>">
                      <a href="<?php echo base_url ?>admin/?page=lesson/assignment" class="nav-link <?php echo ($page === 'lesson/assignment') ? 'active' : ''; ?>">
                        <i class="nav-icon fas fa-list"></i>
                        <p>
                          Question Paper & Assignments
                        </p>
                      </a>
                    </li>
                    <!--<li class="nav-item dropdown">
