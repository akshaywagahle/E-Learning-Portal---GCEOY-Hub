...
<!-- Navigation Bar -->
  ...
  <div class="title2" id="c++" style="margin-top:-33%">
		<span>Question paper and answers</span>
	...
	<center>
      ...
      $sql = "SELECT * from assignm where types='Paper' and academic_year_id = '$s' and subject_id='$d'";
      $i=1;
      ...
      <div class="fpart2">
        <img src="image/qa.jpeg">
        <a href="faculty/uploads/<?php echo $links ?>"><button>Click to Open</button></a><br><br>
