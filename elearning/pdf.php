...
<!-- Navigation Bar -->
  ...
  <div class="title2" id="c++" style="margin-top:-33%">
		<span>Start learning with Standard Books</span>
	...
	<center>
      ...
      $sql = "SELECT * from lessons where types='Pdf' and academic_year_id = '$s' and subject_id='$d'";
      ...
      while ($row=mysqli_fetch_array($query)){
        ...
        <div class="dcard2"><span class="tag" ><?php echo $i++ ?></span>
            <div class="fpart2">
              <img src="image/pdf.jpg">
              <a href="<?php echo $links ?>"><button>Click to Open PDF</button></a><br><br>
